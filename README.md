...
Сводка рассчитывается по актуальным записям при каждом запросе: добавление, редактирование и удаление расходов сразу учитываются после обновления страницы.
